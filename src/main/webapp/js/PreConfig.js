...
window.DRAWIO_BASE_URL = 'https://axa-rev-research.github.io/fairness-compass/'; // Replace with path to base of deployment, e.g. https://www.example.com/folder
window.PLUGINS_BASE_PATH = 'https://axa-rev-research.github.io/fairness-compass/src/main/webapp/';
